...
CREATE TABLE #tmpInstructions (id int identity, instr varchar(max), dir varchar(5), cnt int, ncnt int, endPos int, passZero int )
...
SET   dir = LEFT(instr,1)
	, cnt = SUBSTRING(instr,2,LEN(instr)-1)
